...
derle:
		...
		gcc -I ./include/ -o ./bin/main.exe ./lib/Kisi.o ./lib/KisiArrayList.o ./lib/KayacGezegen.o ./lib/BuzDeviGezegen.o ./lib/GazDeviGezegen.o ./lib/Gezegen.o ./lib/GezegenArrayList.o ./lib/UzayAraci.o ./lib/UzayAraciArrayList.o ./lib/DosyaOkuma.o ./lib/Zaman.o ./lib/Simulasyon.o ./lib/Boolean.o ./src/main.c
